...
namespace Cmf.CLI.Core.Objects
{
    ...
    public class Dependency : IEquatable<Dependency>
    {
        ...
        /// </summary>
        [JsonIgnore]
        internal static readonly string[] DefaultDependenciesToIgnore = new string[] { "criticalmanufacturing.deploymentmetadata", "cmf.environment", "cmf.connectiot.packages", "cmf.database" };
